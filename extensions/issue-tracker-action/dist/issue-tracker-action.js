(() => {
  ...
  // extensions/issue-tracker-action/src/utils.ts
  ...
  function App() {
    ...
    const [loading, setLoading] = (0, import_react17.useState)(issueId ? true : false);
    const [issue, setIssue] = (0, import_react17.useState)({ title: "", description: "", id: void 0 });
